	...
	return (
		<div className="max-w-5xl mx-auto px-6 py-20 text-gray-600">
			...
			<p className="mb-6">
				...
				and{" "}
				<code className="text-sm text-black bg-gray-100 px-1 py-1 rounded">API_KEY</code>{" "}
				are not configured in your{" "}
				<code className="text-sm text-black bg-gray-100 px-1 py-1 rounded">.env.local</code>{" "}
				file.
			</p>
			<p className="mb-2">
				Please create a{" "}
